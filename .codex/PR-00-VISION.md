# PR-00-VISION (greentic-interfaces): Add v0.6 vision docs + Codex rules + deprecation policy

**Date:** 2026-02-19  
**Repo:** `greentic-interfaces`  
...
## Repo purpose (v0.6)
Canonical WIT contracts for v0.6.0 (packages/worlds) used by components, runner, operator, extensions.
...
## Repo-specific notes (greentic-interfaces)
Flag as legacy:
- Any non-canonical WIT worlds/interfaces kept only for compat
- Any “alternate” worlds that appear equally supported in docs
Canonical must emphasize:
- The single canonical v0.6 package/world set
- Naming/versioning rules
- How runner/operator call components (worlds + envelope expectations)
