...
| `events-emitter-v1` | `greentic:events/emitter@1.0.0` (`emitter`) | [`package.wit`](https://greentic-ai.github.io/greentic-interfaces/events@1.0.0/package.wit) | Fire-and-forget event emission; retained inside `events@1.0.0` but not re-exported by host/guest crates. |
