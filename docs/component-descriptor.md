...
- `component@0.6.0` uses CBOR payloads (`greentic:component@0.6.0`, world `component-v0-v6-v0`) and expects `descriptor.ops`. Hosts may support both versions during transition; use the descriptor to discover which version a component exposes.
