...
- **Platform-base (kept)**: component@0.4.0/0.5.0/1.0.0, component-v1@0.1.0, pack-export (all), pack-validate@0.1.0, common-types@0.1.0, types-core@0.2.0/0.4.0, state-store@1.0.0, http-client@1.0.0/1.1.0, telemetry-logger@1.0.0, lifecycle@1.0.0, worker@1.0.0, build@1.0.0, scan@1.0.0, signing@1.0.0, attestation@1.0.0, policy@1.0.0, metadata@1.0.0, source@1.0.0, distribution@1.0.0, oci@1.0.0, repo-ui-actions@1.0.0, deploy-plan@1.0.0, oauth-broker@1.0.0, runner-host@1.0.0, wasix-mcp*, provider-common@0.0.2.
