...
> Legacy note: this page captures migration off removed surfaces.
> For canonical ABI direction, see `docs/vision/v0_6.md`. For compatibility matrix, see `docs/vision/legacy.md`.
